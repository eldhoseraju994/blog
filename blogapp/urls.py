...
from .views import NewBlogView, blogs, Add_User, BlogDetailView, AddCommentToBlogView, LoginView, LogoutView, \
    AddReplyToComment, AddReplyToCommentView, BlogDeleteView, BlogEdit, RegistrationSuccess

urlpatterns = [
    path('', blogs, name='blogs'),
    path('user/new/', Add_User, name='Add_User'),
    path('user/registration/<str:key>', RegistrationSuccess.as_view(), name='product_success'),
